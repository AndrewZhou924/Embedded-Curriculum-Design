...
def chineseRecognize():
    ...
    if (__global_times == 0): # first time
        ...
        # DEBUG
        print("==> [2] chineseRecognize:", temp_image.shape) # (1, 64, 64, 1)
...
'''
def chineseRecognizeSingleImage():
    oldtime = datetime.datetime.now()
    __graph1, __sess1 = predictPrepare() #加载模型，准备好预测
...
if __name__ == "__main__":
    result = chineseRecognizeSingleImage()
