...
```
# model1: facades_label2photo
python test.py --dataroot images/test/ --name facades_label2photo_pretrained --model test --netG unet_256 --direction BtoA --dataset_mode single --norm batch

# model2: edges2shoes
python test.py --dataroot images/test/ --name edges2shoes_pretrained --model test --netG unet_256 --direction BtoA --dataset_mode single --norm batch
```
